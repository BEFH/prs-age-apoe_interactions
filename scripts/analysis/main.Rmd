...
```{r, echo=F}
age_lm_nocc <- lm(PRS_1e_minus05 ~ aaoaae2 + APOE + sex + jointPC1 + jointPC2 + jointPC3 +
  jointPC4 + jointPC5 + jointPC6 + jointPC7 + jointPC8 + jointPC9 + jointPC10,
  data = scores_std)
...
```{r, echo=F}
lm_case_nointeract <- lm(PRS_1e_minus05 ~ aaoaae2 + E4strat + sex + 
  jointPC1 + jointPC2 + jointPC3 + jointPC4 + jointPC5 + jointPC6 +
  jointPC7 + jointPC8 + jointPC9 + jointPC10, data = case_age_strat)

lm_case_interact <- lm(PRS_1e_minus05 ~ aaoaae2 * E4strat + sex +
  jointPC1 + jointPC2 + jointPC3 + jointPC4 + jointPC5 + jointPC6 +
  jointPC7 + jointPC8 + jointPC9 + jointPC10, data = case_age_strat)
...
```{r, echo=F}
case <- plot_model(lm_case_interact, type = "int") %>% intplot_common +
...
```{r, echo=F}
lm_ctrl_nointeract <- lm(PRS_1e_minus05 ~ aaoaae2 + E4strat + sex +
  jointPC1 + jointPC2 + jointPC3 + jointPC4 + jointPC5 + jointPC6 +
  jointPC7 + jointPC8 + jointPC9 + jointPC10, data = ctrl_age_strat)
lm_ctrl_interact <- lm(PRS_1e_minus05 ~ aaoaae2 * E4strat + sex +
  jointPC1 + jointPC2 + jointPC3 + jointPC4 + jointPC5 + jointPC6 +
  jointPC7 + jointPC8 + jointPC9 + jointPC10, data = ctrl_age_strat)
...
```{r, echo=F}
cont <- plot_model(lm_ctrl_interact, type = "int") %>% intplot_common +
